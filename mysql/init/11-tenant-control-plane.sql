-- Fresh-install equivalent of mysql/migrations/20260830_tenant_control_plane.sql.
...
CREATE TABLE IF NOT EXISTS dc_tenant_robot (
  ...
  liquidity_profile_id varchar(64) COLLATE utf8mb4_bin DEFAULT NULL,
  liquidity_profile_version bigint unsigned DEFAULT NULL,
