...
for tag_var in CLICKHOUSE_IMAGE_TAG CLICKHOUSE_DB_NAME CLICKHOUSE_HOST CLICKHOUSE_HTTP_PORT CLICKHOUSE_NATIVE_PORT CLICKHOUSE_USERNAME ZOOKEEPER_TAG GW_TAG LOGINSVR_TAG MDSVR_TAG APSSVR_TAG QUANTSVR_TAG INDSVR_TAG SIMSVR_TAG BATCHSVR_TAG WEB_TAG; do
  if [[ -z "${!tag_var:-}" ]]; then
