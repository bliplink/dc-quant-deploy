...
最终稳态观察窗口为 `2026-09-07 11:21:41 UTC` 至 `2026-09-07 11:31:28 UTC`。窗口内 Robot 保持 `RUNNING/40`，MDSvr 快照最小买卖档为 `10/10`，Web 的 2316 个高频样本最小买卖档为 `10/10`，页面错误 `0`，混合订单新增接受 `1772`，新增拒绝 `0`，新增盘口缺档 `0`。
...
- 最终窗口 MDSvr 采样行数 `444`，买卖档范围均为 `10..10`，非 `RUNNING` 行数 `0`，Web 非 200 行数 `0`。
