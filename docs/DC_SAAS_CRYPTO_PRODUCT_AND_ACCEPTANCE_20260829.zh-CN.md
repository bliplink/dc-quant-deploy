...
验收环境：`172.16.97.64`，`location=CORE_E2E`
...
- Web 地址：`http://172.16.97.64:18088/#/login?location=CORE_E2E`
...
Web 源码提交为 `b3f278cd3aef49b1445c1e98b95e77b9481f4484`，公开镜像为 `ghcr.io/bliplink/dc-saas-trade-web@sha256:19fc4c4b4d55b29d6db75a6279a8e89993405e7d53f6f7e79140568cba161b2d`。生产构建、公开镜像构建和匿名拉取验证已通过；本地生产构建截图已归档。64 环境的新界面部署、浏览器自动化和远端截图仍需等待主机 SSH 恢复后补充，不能用本地截图替代远端验收结论。
