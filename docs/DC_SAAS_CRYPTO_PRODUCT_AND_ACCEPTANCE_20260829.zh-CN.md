...
Web 源码提交为 `b5b29ae7586ea8572cf9263458d2799a7a18ecce`，公开镜像为 `ghcr.io/bliplink/dc-saas-trade-web@sha256:d3b51066e83ac08c74dba44cba12432c2706070f2af3e6dbd67d2e84d357fb92`。生产构建、公开镜像构建和匿名拉取验证已通过；本地生产构建截图已归档。64 环境的新界面部署、浏览器自动化和远端截图仍需等待主机 SSH 恢复后补充，不能用本地截图替代远端验收结论。
