...
{"serverName":"OrderSvr","method":"placeOrder","key":"${LIQ_LOCATION}\u001f4\u001fBTCUSDT","content":{"OCType":"OPEN","OrderQty":"0.001","OrdType":"Limit","ClOrdID":"LIQ-E2E-MAKER-$(date +%s%N)","Terminal":"API","AlgoName":"cross","Side":"Buy","Price":"${entry_price}","UserID":"${MAKER_USER}","MarketIndicator":"4","TimeInForce":"GTC","SecurityID":"BTCUSDT","Location":"${LIQ_LOCATION}"}}
JSON
